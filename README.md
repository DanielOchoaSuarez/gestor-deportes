...
Aplicación encargada de realizar los procesos de planes deportivos del sistema.
...
1. `pipenv shell`
2. `pipenv install`
3. `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3003`
...
- `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3003 --reload`
